...
public:
    ...
    /// @ensures
    ///
    void enable_wrcr0_exiting(vmcs_n::value_type mask, vmcs_n::value_type shadow);
    ...
    /// @ensures
    ///
    void enable_wrcr4_exiting(vmcs_n::value_type mask, vmcs_n::value_type shadow);
    ...
    /// @ensures
    ///
    void add_rdmsr_handler(vmcs_n::value_type msr, rdmsr::handler_delegate_t &&d);
    ...
    /// @ensures
    ///
    /// @return Returns the address of the msr bitmap
    ///
