...
struct EXPORT_VIC xapic_ctl final : public lapic_ctl
{
    ...
    /// Register reads
    ///
    value_t read_id() noexcept override;
    value_t read_version() noexcept override;
    value_t read_tpr() noexcept override;
    value_t read_ldr() noexcept override;
    value_t read_svr() noexcept override;
    value_t read_icr() noexcept override;
    value_t read_isr(const index idx) noexcept override;
    value_t read_tmr(const index idx) noexcept override;
    value_t read_irr(const index idx) noexcept override;
    value_t read_lvt(const lvt_reg reg) noexcept override;
    value_t read_count(const count_reg reg) noexcept override;
    value_t read_div_config() noexcept override;

    ///
    /// Register writes
    ///
    void write_eoi() noexcept override;
    void write_tpr(const value_t tpr) noexcept override;
    void write_svr(const value_t svr) noexcept override;
    void write_icr(const value_t icr) noexcept override;
    void write_lvt(const lvt_reg reg, const value_t val) noexcept override;
    void write_init_count(const value_t count) noexcept override;
    void write_div_config(const value_t config) noexcept override;
    ...
    ///
    void write_self_ipi(const vector_t vec) noexcept override;
    ...
    ///
    bool level_triggered(const vector_t vec) noexcept override;
    ...
    /// the vector prior to the call
    ///
    bool in_service(const vector_t vec) noexcept override;
